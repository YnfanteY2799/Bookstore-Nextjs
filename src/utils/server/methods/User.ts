...
import type { TLoginFS, TypeRegisterMFS } from "@/configs";
...
export type TLogUser = { id: number; username: string; hashed_password: string };

export async function findUserByEmail({ email }: Omit<TLoginFS, "password">): Promise<TLogUser> {
  try {
